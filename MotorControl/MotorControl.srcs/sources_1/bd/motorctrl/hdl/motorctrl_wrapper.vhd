...
--Command     : generate_target motorctrl_wrapper.bd
...
end motorctrl_wrapper;

architecture STRUCTURE of motorctrl_wrapper is
...
motorctrl_i: component motorctrl
     port map (
      ...
      PIN_D(1 downto 0) => PIN_D(1 downto 0),
      SPY_tri_o(3 downto 0) => spy_tri_o(3 downto 0),
      TRIGGER => TRIGGER,
