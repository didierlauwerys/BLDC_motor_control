...
################################################################
# This is a generated script based on design: motorctrl
#
...
proc create_root_design { parentCell } {
  ...
  set SPY [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 SPY ]
  ...
  # Create ports
  set PIN_A [ create_bd_port -dir O -from 1 -to 0 PIN_A ]
  set PIN_B [ create_bd_port -dir O -from 1 -to 0 PIN_B ]
  set PIN_C [ create_bd_port -dir O -from 1 -to 0 PIN_C ]
  set PIN_D [ create_bd_port -dir O -from 1 -to 0 PIN_D ]
...
CONFIG.CONST_WIDTH {2} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO2 [get_bd_intf_ports SPY] [get_bd_intf_pins axi_gpio_1/GPIO2]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins PWM_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins StateController_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins PI_CTRL_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PI_CTRL_0/S00_AXI/S00_AXI_reg] SEG_PI_CTRL_0_S00_AXI_reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs StateController_0/S00_AXI/S00_AXI_reg] SEG_StateController_0_S00_AXI_reg
