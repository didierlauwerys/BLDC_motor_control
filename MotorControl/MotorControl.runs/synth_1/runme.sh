...
HD_PWD='D:/GITES/MotorControl/MotorControl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log motorctrl_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source motorctrl_wrapper.tcl
