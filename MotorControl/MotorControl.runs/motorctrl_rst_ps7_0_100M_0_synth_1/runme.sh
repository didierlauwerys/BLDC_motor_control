...
HD_PWD='D:/GITES/MotorControl/MotorControl.runs/motorctrl_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log motorctrl_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source motorctrl_rst_ps7_0_100M_0.tcl
