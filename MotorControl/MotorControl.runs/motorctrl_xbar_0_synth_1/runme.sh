...
HD_PWD='D:/GITES/MotorControl/MotorControl.runs/motorctrl_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log motorctrl_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source motorctrl_xbar_0.tcl
