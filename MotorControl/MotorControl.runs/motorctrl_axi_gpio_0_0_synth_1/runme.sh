...
HD_PWD='D:/GITES/MotorControl/MotorControl.runs/motorctrl_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log motorctrl_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source motorctrl_axi_gpio_0_0.tcl
