...
HD_PWD='C:/Embedded/GITES/MotorControl/MotorControl.runs/motorctrl_StateController_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log motorctrl_StateController_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source motorctrl_StateController_0_0.tcl
