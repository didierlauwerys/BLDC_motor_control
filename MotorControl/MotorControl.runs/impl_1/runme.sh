...
HD_PWD='D:/GITES/MotorControl/MotorControl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log motorctrl_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source motorctrl_wrapper.tcl -notrace
